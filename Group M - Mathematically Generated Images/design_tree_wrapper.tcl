...
################################################################
# This is a generated script based on design: design_tree
#
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
User_Company:SysGen:cordic_sin_cos:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: cordic_sin_cos_0, and set properties
  set cordic_sin_cos_0 [ create_bd_cell -type ip -vlnv User_Company:SysGen:cordic_sin_cos:1.0 cordic_sin_cos_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins cordic_sin_cos_0/cordic_sin_cos_s_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins cordic_sin_cos_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins cordic_sin_cos_0/cordic_sin_cos_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs cordic_sin_cos_0/cordic_sin_cos_s_axi/reg0] SEG_cordic_sin_cos_0_reg0
